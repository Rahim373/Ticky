    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    DisocuntId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    TicketId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DiscountedTickets", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DiscountedTickets_Discounts_DisocuntId",
                        column: x => x.DisocuntId,
                        principalTable: "Discounts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DiscountedTickets_Tickets_TicketId",
                        column: x => x.TicketId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DiscountedTickets_DisocuntId",
                table: "DiscountedTickets",
                column: "DisocuntId");

            migrationBuilder.CreateIndex(
                name: "IX_DiscountedTickets_TicketId_DisocuntId",
                table: "DiscountedTickets",
                columns: new[] { "TicketId", "DisocuntId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EventOwners_EventId_UserId_OwnerShipType",
                table: "EventOwners",
                columns: new[] { "EventId", "UserId", "OwnerShipType" },
                unique: true);
